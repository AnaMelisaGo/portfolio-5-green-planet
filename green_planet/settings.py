...
SECRET_KEY = 'django-insecure-a8uqde2r-46k%gj@(yz$9^h^$ivn^-o*c=g%oubz*rtgp+x3=#'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['portfolio-5-green-planet.herokuapp.com', 'localhost']
...
DEFAULT_FROM_EMAIL = 'greenplanet@example.com'
